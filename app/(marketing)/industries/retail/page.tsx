        ...
        <div className="section-container">
          <div className="max-w-4xl mx-auto">
            ...
            >
              {[
                {
                  title: 'Holiday Surge Staffing',
                  desc: 'Black Friday? Christmas rush? We deploy 100+ trained associates in 48 hours.'
                },
                {
                  title: 'Store Opening Teams',
                  desc: 'New location? We staff entire stores—manager, associates, stockers—day one ready.'
                },
                {
                  title: 'POS System Experts',
                  desc: 'Square, Shopify POS, Clover, NCR, Lightspeed—our talent knows the platforms.'
                },
                {
                  title: 'Multi-Store Scaling',
                  desc: 'Expanding 10 stores? 100 stores? We scale staffing with your growth.'
                }
              ].map((item, index) => (
      ...
      <section className="py-16 bg-gradient-to-br from-trust-blue-50 to-success-green-50">
        <div className="section-container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              {[
                { stat: '48hrs', label: 'Average response time for seasonal staffing' },
                { stat: '91%', label: 'Associate retention rate (seasonal)' },
                { stat: '$5.6T', label: 'US retail market we serve' }
              ].map((item, index) => (
