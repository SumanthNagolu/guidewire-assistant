...
export const metadata = {
  title: 'Retail Staffing Solutions | InTime eSolutions',
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Retail Staffing Solutions</span>
            </div>
            <h1 className="text-h1 font-heading mb-6">
              Retail Staffing Solutions
            </h1>
            <p className="text-xl mb-8 text-sky-blue-500 leading-relaxed">
              Retail staffing that succeeds when demand planning meets frontline excellence.
            </p>
