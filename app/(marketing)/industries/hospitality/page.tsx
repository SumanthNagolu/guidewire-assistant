...
export const metadata = {
  title: 'Hospitality Staffing | InTime eSolutions',
...
export default function Page() {
  const roles = [
    ...
    "Hospitality Internal Sales Support",
    "Hospitality Administrator",
    "VP, Hospitality Brand and Marketing",
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Hospitality Staffing</span>
            </div>
            <h1 className="text-h1 font-heading mb-6">
              Hospitality Staffing
            </h1>
            <p className="text-xl mb-8 text-sky-blue-500 leading-relaxed">
              Complete hospitality recruitment lifecycle with structured, professional process that protects brand standards.
            </p>
