...
export const metadata = {
  title: 'Government & Public Sector Staffing | InTime eSolutions',
  description: 'Security-cleared talent for federal, state, and municipal projects. IT, cybersecurity, data analytics, and program management.',
  keywords: 'government staffing, public sector jobs, security clearance jobs, federal contractor, government IT jobs',
};
