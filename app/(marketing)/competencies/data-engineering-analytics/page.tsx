...
export const metadata = {
  title: 'Data Engineering and Analytics | InTime eSolutions',
    ...
    <>
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-sky-blue-500 leading-relaxed">
              Enterprise Data Lake, Master Data Management, Data Virtualization, and Data Governance.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="section-container max-w-4xl">
          <div className="mb-8">
            <p className="text-lg text-wisdom-gray-700 leading-relaxed">Data is advantage—if engineered for access and action. We design strategies and platforms that manage, organize, and analyze data for faster, smarter decisions—augmented by AI and ML. Solutions include Enterprise Data Lake, Master Data Management, Data Virtualization, and Enterprise Data Governance.</p>
          </div>
        </div>
      </section>
