...
export const metadata = {
  title: 'Enterprise Mobility | InTime eSolutions',
    ...
    <>
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-sky-blue-500 leading-relaxed">
              iOS and Android mobile solutions with MapKit, Push Notifications, social integration, and more.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="section-container max-w-4xl">
          <div className="mb-8">
            <p className="text-lg text-wisdom-gray-700 leading-relaxed">iOS: MapKit, AV Foundation, Core Graphics, Apple Push Notification, Facebook/Twitter integration, Cocoa Touch, Core Data. Android: Location‑based Services, Facebook APIs, Android media APIs, Wi‑Fi APIs, SQLite, MySQL. In‑house framework for rich client/server mobility, unbiased technology competence, and dedicated UX teams.</p>
          </div>
        </div>
      </section>
