...
export const metadata = {
  title: 'Quality Assurance | InTime eSolutions',
    ...
    <>
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8 text-sky-blue-500 leading-relaxed">
              Comprehensive QA services across the SDLC—feature verification, automation, performance, and security testing.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="section-container max-w-4xl">
          <div className="mb-8">
            <p className="text-lg text-wisdom-gray-700 leading-relaxed">We plan and test across the SDLC: feature verification, black/white box, usability, component, load, compatibility—backed by rigorous defect reporting. Testing services include Performance, Regression, Functionality, Interoperability, Integration, API, Configuration, Usability, Test Automation, and Requirements Validation.</p>
          </div>
        </div>
      </section>
