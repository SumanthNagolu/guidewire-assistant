      ...
      <section className="relative bg-gradient-to-br from-innovation-orange-600 via-innovation-orange to-innovation-orange-700 text-white py-20">
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl">
            ...
            <Link href="/login/student" className="bg-white text-innovation-orange hover:bg-wisdom-gray-50 font-semibold py-3 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl inline-flex items-center">
